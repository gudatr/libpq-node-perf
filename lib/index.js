...
exports.PostgresClient = exports.types = exports.ClientConfig = void 0;
...
class Postgres {
    constructor(config) {
        ...
        this.escapeMatches = {};
        this.queue = [];
        this._queueSize = (_a = config.queueSize) !== null && _a !== void 0 ? _a : 257590;
        for (let i = 0; i < this._queueSize; i++)
            this.queue[i] = EMPTY_FUNCTION;
     ...
     * @returns
     */
    async query(name, text, values = EMPTY_ARRAY) {
     ...
     * @returns
     */
    async queryCount(name, text, values = EMPTY_ARRAY) {
        let client = await this.connect();
        try {
 ...
 */
class ClientConfig {
    constructor(user, host, port, database, schema, socket, password, threads = 10, queueSize = 65535, escapeChar = '\\', valuesOnly = false, parseInt8AsString = false) {
        this.user = user;
        this.host = host;
        this.port = port;
        ...
        this.parseInt8AsString = parseInt8AsString;
    }
}
...
for (let i = 0; i < 8192; i++) {
    ...
    if (typesFlat[i].name === 'noParse')
        typesFlat[i] = returnValue;
}
exports.types = typesFlat;
...
class PostgresClient extends Libpq {
     ...
     * @returns
     */
    query(queryName, text, values = EMPTY_ARRAY) {
     ...
     */
    async queryCount(queryName, text, values = EMPTY_ARRAY) {
        this.mode = 1;
    ...
    constructor(valuesOnly, parentPool) {
        super();
        ...
        this.mode = 1;
        this.prepared = {};
        this.namesNonPrepared = [];
        this.typesNonPrepared = [];
    ...
    getResultInfo() {
        ...
        for (let x = 0; x < this.fieldCount; x++) {
            ...
            this.types[x] = exports.types[this.$ftype(x)];
        }
    }
    emitResult() {
...
class ResultInfo {
    constructor(fieldCount, names, types) {
